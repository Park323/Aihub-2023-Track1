...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default="decode",
        choices=["decode", "asr_inference", "avsr_inference", "vsr_inference"],
        help="name of logfile, e.g., 'decode' (espnet1), "
        "'asr_inference' (espnet2), and 'avsr_inference' (espnet2)",
    )
    parser.add_argument(
        "--input-shift",
        type=float,
    ...
    parser.add_argument(
        ...
        choices=["input lengths", "speech length", "visual length"],
