...
# generate the utt2spk, wav.scp, mp4.scp and text files
log "Generating the utt2spk, wav.scp, mp4.scp and text files"
python3 ./local/data_prep.py --pretrain_path ${LRS3}/pretrain --train_val_path ${LRS3}/trainval --test_path ${LRS3}/test
