...
from espnet2.schedulers.cosine_lr import WarmupCosineScheduler
...
scheduler_classes = dict(
    ...
    cosinewarmup=WarmupCosineScheduler,
...
class AbsTask(ABC):
    ...
    def get_parser(cls) -> config_argparse.ArgumentParser:
        ...
        group.add_argument(
            ...
            type=int,
            default=None,
            help="The maximum length of each utterance in mini-batch. Used if batch_type='len'.",
        )
        group.add_argument(
            "--batch_size",
            type=int,
        ...
        if args.dry_run:
            ...
            if schedulers:
                for scheduler in schedulers:
                    if hasattr(scheduler, "set_iter_per_epoch"):
                        scheduler.set_iter_per_epoch(int(len(train_iter_factory.sampler)/args.accum_grad))
    ...
    def build_sequence_iter_factory(
        ...
        batch_sampler = build_batch_sampler(
            ...
            max_utt_len=iter_options.max_utt_len,
        ...
        if iter_options.distributed:
            ...
            if hasattr(batches, "distribute_batches"):
                batches.distribute_batches(rank, world_size)
            else:
