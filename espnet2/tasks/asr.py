...
from espnet2.asr.frontend.raw import RawFrontend
from espnet2.asr.frontend.resnet import ResNet18
...
from espnet2.asr.specaug.timeaug import TimeAug
...
class ASRTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            "--curriculum_epochs",
            default=None,
            help="The number of epochs for each curriculum step (Deprecated)",
        )

        group.add_argument(
            "--curriculum_max_len",
            default=None,
            help="The maximum length of audio inputs for each curriculum step, paired with `curriculum_epochs` (Deprecated)",
        )
